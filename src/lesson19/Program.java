...
public class Program {
    public static void main(String[] args) {
        ...
        University un2 = new University("Начальника школа", 150);
        ...
        switch (res) {
            ...
            default->System.out.println("Одинаковы");
        }
        ...
        System.out.println("\nСортировка по кол. людей: ");
        Collections.sort(list, sortUniv);
        for(University num: list){
            System.out.println(num.getName() + " " + num.getNum_of_students());
        }
    }
}
