...
public class Menu {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2. Отобрадение массива");
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("Введите элемента массива, который хотите найти: ");
                    int item = input.nextInt();
                    index = searchArray(list, item);
                    if (index == -1)
